...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Ápr 30. 21:29
...
CREATE TABLE `rendezvenyek` (
  ...
  `megye` varchar(25) COLLATE utf8_hungarian_ci NOT NULL,
...
INSERT INTO `rendezvenyek` (`rendezvenyID`, `szervezoID`, `nev`, `reszveteliMod`, `megye`, `rendezvenyDatuma`, `rendezvenyIdeje`, `helyszin`, `leiras`, `jegyAr`, `kep`, `elerhetoJegyekSzama`, `eladottJegyekSzama`) VALUES
(17, 1, 'Sound on!', 0, 'Tolna', '2022-04-30', '23:00:00', 'Miami', 'Hhahah, Hihihih!\r\n\r\n', 3450, 'kepek/festival.jpg', 2, 3),
(19, 1, 'Mókus 2', 0, 'Pest', '2022-04-29', '22:00:00', 'Budapest Park', 'Ez egy mókus\r\nXD', 2500, 'kepek/mokus.jpg', 0, 2),
(20, 1, 'Online ballagás', 1, 'Online', '2022-04-30', '08:00:00', 'Zoom', 'Online ballagás a végzősöknek', 300, 'kepek/ballagas.jpg', 50, 0);
...
--
ALTER TABLE `kosar`
  MODIFY `kosarID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT a táblához `rendezvenyek`
--
ALTER TABLE `rendezvenyek`
  MODIFY `rendezvenyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
