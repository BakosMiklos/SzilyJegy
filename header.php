        ...
        <div class="container-fluid">
            <a class="navbar-brand mb-0 h1" href='index.php'>
                ...
                <div class="collapse navbar-collapse t" id="navbarSupportedContent">
                                ...
                                if(mysqli_num_rows($products_run) > 0)
                                {
                                    foreach($products_run as $proditems) :
                                        ...
                                        <div class="form-outline mb-7 d-flex justify-content-center">
                                            <a href="">
                                                <p class="varosok"><?= $proditems['helyszin']; ?></p>
                                            </a>
                                        </div>
                                        <?php
                                    endforeach;
                    ...
                    <li class="nav-item">
                        <form>
                            <a class="nav-link" href="maintance.html">online</a>
                        </form>
                    </li>
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-dark teszt" aria-labelledby="navbarDropdown">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><a href="maintance.html"><input type="submit" value="Kosár kezelése" class="btn btn-outline-success"></a></td>
                                </tr>
                            </table>
                        </ul>
                    </li>
...
$query = "SELECT kep, nev, rendezvenyDatuma, rendezvenyIdeje, rendezvenyID FROM rendezvenyek where nev like '$keywords'";
