                ...
                <div class="collapse navbar-collapse t" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <!-- Megyék kiiratása -->
                            <ul class="dropdown-menu bg-dark scroll teszt" aria-labelledby="navbarDropdown">
                            <?php
                                $megyek = [
                                    "Bács-Kiskun",
                                    "Baranya",
                ...
                ?>
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark teszt scroll2" aria-labelledby="navbarDropdown">
                                <!-- Kosár tartalma -->
                                <table>
                                    <tr>
                                    ...
                                    if(mysqli_num_rows($products_run) > 0)
                                    {
                                        foreach($products_run as $proditems) :
                                            ...
                                            <tr>
                                                <div class="form-outline d-flex justify-content-center">
                                                    <td><?=$proditems['darab']?>db jegy</td>
                                                </div>
                                                <div class="form-outline d-flex justify-content-center">
                                                    <td><?=$proditems['fizetendo']?>Ft&emsp;</td>
                                                </div>
                                                <div class="form-outline d-flex justify-content-center">
                                                    <td class="btn btn-outline-success"><a href="kosartorles.php?id=<?=$proditems['rendezvenyID']?>">Törlés</td>
                                                </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark teszt" aria-labelledby="navbarDropdown">
                                ...
                                <table>
                                    ...
                                    <a href="elfelejtett_jelszo.php" id="elf_jelsz">Elfelejtettem a jelszavam<br><br></a>
