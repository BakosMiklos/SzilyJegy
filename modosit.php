...
<body>
                                  ...
                                  <div class="card-body p-5">
                                      ...
                                      <form method='post' enctype='multipart/form-data'>
                                        ...
                                        <div class="form-outline mb-4 kartya_szele">
                                          ...
                                          {
                                              ?>
                                              <option value='0'>Helyszíni</option>
    ...
    if(isset($_POST['rogzit']))
    {
      ...
      $query = "UPDATE `rendezvenyek` SET `nev`='".$nev."',`reszveteliMod`='".$reszvetelimod."',`megye`='".$megye."',`rendezvenyDatuma`='".$rendezvenydatuma."',`rendezvenyIdeje`='".$rendezvenyideje."',`helyszin`='".$helyszin."',`leiras`='".$leiras."',`jegyAr`='".$jegyar."',`kep`='".$kep."',`elerhetoJegyekSzama`='".$eladhatojegyekszama."' WHERE `rendezvenyek`.`rendezvenyID`='".$_GET['modosit']."'";
