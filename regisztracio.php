                        ...
                        <div class="card-body p-5">
                            ...
                            <form method="post">
                                ...
                                <div class="form-outline mb-4 d-flex justify-content-center kartya_szele">
                                    ...
                                    <input type='text' name='tel_szam' placeholder='Telefonszám' id="form3Example3cg" class="form-control form-control-sm">
                                </div>
                                <div class="form-outline mb-4 d-flex justify-content-center kartya_szele">
                                ...
                                <div class="form-outline mb-4 d-flex justify-content-center kartya_szele">
                                    ...
                                    <div id="form3Example1cg" class="form-control form-control-sm">
                                    
                                        <select name='megye' placeholder="Válaszd ki a megyéd!">
                                        <?php

                                          for($i=0; $i<count($megyek); $i++)
                                          {
                                              ?>
                                                <option value="<?=$megyek[$i]?>" class="asd"><?=$megyek[$i]?></option>
                                              <?php
                                          }
                                          ?>
                                        </select>
...
if(isset($_POST['gombAltalanos']))
{
    ...
    if(isset($_POST['gombAltalanos'])) {
        if($vez_nev == NULL || $ker_nev == NULL || $email_cim == NULL || $jelszo1 == NULL || $jelszo2 == NULL || 
           $tel_szam == NULL|| $ir_szam == NULL || $megye == "Válaszd ki a megyéd!"     || $varos == NULL   || $cim == NULL)
        {
            ?>
...
if(isset($_POST['gombSzervezo']))
{
    ...
    if(isset($_POST['gombSzervezo'])) {
        ...
        else
        {
            ...
            {
                $sql = "SELECT * FROM szervezok WHERE email='$email_cim' LIMIT 1";
                $result = mysqli_query($con, $sql);
                $felhasznalo = mysqli_fetch_assoc($result);
...
<script src="header/headerRegisztracio/regisztracio_segito.js"></script>
