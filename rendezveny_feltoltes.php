...
if(isset($_POST['gomb']))
{
  ...
  $query = "INSERT INTO `rendezvenyek`(`szervezoID`, `nev`, `reszveteliMod`, `rendezvenyDatuma`, `rendezvenyIdeje`, `helyszin`, `leiras`, `jegyAr`, `kep`, `elerhetoJegyekSzama`, `eladottJegyekSzama`)
